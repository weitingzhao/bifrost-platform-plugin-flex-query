...
docker-build:
	docker build --platform linux/amd64 -t bifrost-flex-query:0.6.0 \
	  --build-context core=../bifrost-trade-core \
	  -f Dockerfile .
	docker tag bifrost-flex-query:0.6.0 192.168.10.73:30500/bifrost-flex-query:0.6.0
	docker tag bifrost-flex-query:0.6.0 192.168.10.73:30500/bifrost-flex-query:latest
	docker push 192.168.10.73:30500/bifrost-flex-query:0.6.0
